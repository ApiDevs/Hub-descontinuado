...
public enum ParticleEffect
{
    ...
    static {
        ParticleEffect.NAME_MAP = new HashMap<String, ParticleEffect>();
        ParticleEffect.ID_MAP = new HashMap<Integer, ParticleEffect>();
    ...
    private static class ParticleDataException extends RuntimeException
    {
        ...
        static {
            ParticleDataException.serialVersionUID = 3203085387160737484L;
        }
    }
    ...
    private static class ParticleColorException extends RuntimeException
    {
        ...
        static {
            ParticleColorException.serialVersionUID = 3203085387160737484L;
        }
    }
    ...
    private static class ParticleVersionException extends RuntimeException
    {
        ...
        static {
            ParticleVersionException.serialVersionUID = 3203085387160737484L;
        }
    }
    ...
    public static class ParticlePacket
    {
        ...
        private static class VersionIncompatibleException extends RuntimeException
        {
            ...
            static {
                VersionIncompatibleException.serialVersionUID = 3203085387160737484L;
            }
        }
        ...
        private static class PacketInstantiationException extends RuntimeException
        {
            ...
            static {
                PacketInstantiationException.serialVersionUID = 3203085387160737484L;
            }
        }
        ...
        private static class PacketSendingException extends RuntimeException
        {
            ...
            static {
                PacketSendingException.serialVersionUID = 3203085387160737484L;
            }
        }
    }
}
